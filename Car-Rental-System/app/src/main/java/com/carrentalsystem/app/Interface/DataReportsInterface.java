...
public interface DataReportsInterface {
    ...
    List<List<Object>> fetchRevenueReportFromEachCar(String emailId);
    List<List<Object>> fetchRentedCountPerCar(String emailId);
    List<List<Object>> fetchRatingPerCar(String emailId);
